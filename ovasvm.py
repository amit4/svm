...
if __name__ == '__main__':
  ...
  classifier = OVASVMLayer(input=x, n_in=300, n_out=5)
  ...
  cost,updates = classifier.ova_svm_cost(y1)
  ...
  train_model = theano.function(
        ...
        givens={
            ...
            y: train_set_y1[index * batch_size: (index + 1) * batch_size]
        }
  )
  ...
  for i in xrange(epochs):
    ...
    print 'Pre-training epoch %d, cost ' % i,
    print np.mean(c)
